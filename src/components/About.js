...
class About extends React.Component {
    ...
    render() {
        ...
        return (<>
            ...
            <UserClass name={"Ram(class)"} location={"Dubai(class)"} contactInfo={"Contact Info(class)"} />
            <UserClass name={"Vijay(class)"} location={"Dubai(class)"} contactInfo={"Contact Info(class)"} />
        </>)
    }
}
